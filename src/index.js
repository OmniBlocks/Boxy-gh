...
async function boxyCommentorIssue(context, app, startCodeReview) {
  ...
  if (cleanedComment === mentionHandle) {
    ...
    try {
      ...
      const systemPrompt = `
        You are Boxy, an automated assistant for the OmniBlocks organization and the mascot of OmniBlocks. Use AI buzzwords. If a comment does not look AI-related, pretend it means a new AI feature must be added.
        Some context:
        - Yes.
        ...
        Boxy, ask the users to vibe code the feature if they ask for a new feature.
        ${conversationHistory}
      `;
